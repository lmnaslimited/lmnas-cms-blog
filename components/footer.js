...
export default function Footer() {
  return (
    <footer className="bg-accent-1 border-t mb-20 border-accent-2">
...
<div className="lg:row-span-1 row-span-1 col-span-1 mx-5 px-5 my-5 py-5">
  ...
  <nav className="mt-2 lg:mt-10">
    ...
    <li className="rounded-full mt-4   md::w-3/4 xl:w-3/4">
              <a href="#" className="text-gray-900"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 inline text-th-accent-medium " viewBox="0 0 20 20" fill="currentColor">
...
<div className=" text-center mx-auto py-4 px-40 flex  w-full  flex-col sm:flex-row bg-th-accent-medium  opacity-80">
