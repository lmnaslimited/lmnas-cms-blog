...
export default function DownloadCard({ size, imageSrc, post }) {
    ...
    return (
        <div class={"py-4 md:p-4 " + cardSizeClass}>
            <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden bg-th-accent-medium">
                <h1 class="text-5xl p-5 font-medium text-center text-white title-font mb-2 ">Download Case Studies form Our Resource centre
                </h1>
             ...
             <img src="download-card-5821x3886.jpg"/>
              <button className='px-4 py-4 -mt-48 absolute  mx-28 my-4 bg-purple-400 transform transition hover:scale-105 duration-300 ease-in-out'>
               <h1 className='text-lg font-semibold text-white'>Download Now !</h1>
            </button>
