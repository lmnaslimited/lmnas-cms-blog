...
export default function DownloadCard({ size, imageSrc, post }) {
    ...
    return (
            <div class="my-8 md:my-0 h-full border-2 border-th-primary-medium border-opacity-60 rounded-lg overflow-hidden bg-th-accent-medium">

                <h1 class="text-5xl p-5 font-medium text-center text-gray-100 title-font mb-2 ">Download Case Studies form Our Resource centre
                </h1>
